...
export default function SitToStandExercise() {
    ...
    const { isStarted, count, feedback, start, stop } = useExerciseAI({
        exerciseType: 'sit-to-stand',
        videoRef,
        canvasRef,
        onRepComplete: (c) => console.log("Sat-Up:", c)
    });
                        ...
                        >
                            <div className="relative">
                                ...
                                <div className="w-48 h-48 md:w-64 md:h-64 bg-white/90 backdrop-blur-sm rounded-full flex flex-col items-center justify-center shadow-[0_40px_100px_rgba(0,0,0,0.08)] border-8 border-sage/5">
                                    ...
                                    <span className="text-[10px] md:text-xs font-black text-dark-slate/30 uppercase tracking-[0.3em]">Repetisi</span>
                                </div>
                            </div>
                        </motion.div>
                    )}
                ...
                {isDone && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 md:p-10 bg-white/80 backdrop-blur-2xl">
                        ...
                        >
                            ...
                            <p className="text-lg md:text-xl text-dark-slate/40 font-light mb-12 md:mb-16 italic">Satu langkah kecil untuk kesehatan yang berkelanjutan.</p>
                            ...
                            <div className="grid grid-cols-2 gap-4 md:gap-8 mb-12 md:mb-16">
                                <div className="p-6 md:p-10 bg-[#F4F7EB] rounded-[40px] md:rounded-[50px] flex flex-col items-center">
                                    ...
                                    <span className="mt-2 text-[8px] md:text-[10px] font-black uppercase tracking-widest text-[#556B2F]">Total Repetisi</span>
                                </div>
