...
export default function KneeLiftsExercise() {
    ...
    const { isStarted, count, feedback, start, stop } = useExerciseAI({
        exerciseType: 'knee-lifts',
        videoRef,
        canvasRef,
        onRepComplete: (c) => console.log("Rep:", c)
    });
                ...
                {isDone && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 md:p-10 bg-white/80 backdrop-blur-2xl">
                        ...
                        >
                            ...
                            <p className="text-lg md:text-xl text-dark-slate/40 font-light mb-12 md:mb-16 italic">Sesi latihan selesai.</p>
